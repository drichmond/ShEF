...
file copy -force $SHEF_DIR/hdk/src/lib/crypto/hmac_light.sv            $TARGET_DIR
...
file copy -force $SHEF_DIR/hdk/src/lib/light/light_decryptor.sv         $TARGET_DIR
file copy -force $SHEF_DIR/hdk/src/lib/light/light_encryptor.sv         $TARGET_DIR
file copy -force $CL_DIR/design/cl_bitcoin_defines.vh               $TARGET_DIR
file copy -force $CL_DIR/design/cl_id_defines.vh                      $TARGET_DIR
file copy -force $CL_DIR/design/cl_bitcoin.sv                       $TARGET_DIR 
file copy -force $CL_DIR/design/source/bitcoin.sv                       $TARGET_DIR 
