...
file copy -force $CL_DIR/design/cl_sdp_defines.vh $TARGET_DIR
file copy -force $CL_DIR/design/cl_id_defines.vh $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_axi_mstr.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_axi_read_master.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_axi_write_master.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_counter.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_driver.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_muxes.sv $TARGET_DIR
file copy -force $CL_DIR/design/cl_sdp_regs.sv $TARGET_DIR
